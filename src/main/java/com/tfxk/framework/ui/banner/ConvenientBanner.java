package com.tfxk.framework.ui.banner;
...
import com.tfxk.framework.ui.banner.adapter.CBPageAdapter;
import com.tfxk.framework.ui.banner.holder.CBViewHolderCreator;
import com.tfxk.framework.ui.banner.listener.CBPageChangeListener;
import com.tfxk.framework.ui.banner.listener.OnItemClickListener;
import com.tfxk.framework.ui.banner.view.CBLoopViewPager;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public void updatePages(List<T> datas){
        this.mDatas=datas;
        pageAdapter.updateDatas(datas);
    }
    /**
     * 通知数据变化
