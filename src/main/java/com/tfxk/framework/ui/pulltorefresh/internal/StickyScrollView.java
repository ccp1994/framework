...
public class StickyScrollView extends ScrollView {
    ...
    private com.tfxk.framework.ui.pulltorefresh.internal.ScrollView.OnScrollListener mScrollListener;
    private Callback mStickeyedCallback;
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        if (mScrollListener != null) {
            mScrollListener.onScrollChanged(null, l, t, oldl, oldt);
        }
        doTheStickyThing();
    }
    public void setScrollListener(com.tfxk.framework.ui.pulltorefresh.internal.ScrollView.OnScrollListener scrollListener){
        this.mScrollListener=scrollListener;
    }

    public void setStickyedCallback(Callback callback){
        this.mStickeyedCallback=callback;
    }
        ...
        for (View v : stickyViews) {
            ...
            if (viewTop <= 0) {
                if (viewThatShouldStick == null || viewTop > (getTopForViewRelativeOnlyChild(viewThatShouldStick) - getScrollY() + (clippingToPadding ? 0 : getPaddingTop()))) {
                    ...
                    if(mStickeyedCallback!=null){
                        mStickeyedCallback.call(true);
                    }
                }
            } else {
