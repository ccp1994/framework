...
import com.tfxk.framework.ui.pulltorefresh.internal.FlipLoadingLayout;
import com.tfxk.framework.ui.pulltorefresh.internal.LoadingLayout;
import com.tfxk.framework.ui.pulltorefresh.internal.RotateLoadingLayout;
import com.tfxk.framework.ui.pulltorefresh.internal.SelfLoadingLayout;
import com.tfxk.framework.ui.pulltorefresh.internal.Utils;
import com.tfxk.framework.ui.pulltorefresh.internal.ViewCompat;
...
//		}
    ...
    protected final int getHeaderSize() {
        int height = mHeaderLayout.getContentSize();
        if (height == 0)
            height = ViewUtil.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50);
        return height;
    }
...
//        System.out.println("=======>value:"+value+",mMAxScrollHeight:"+mMaxScrollHeight);
        int maxScrollHeight= (int) ((mMaxScrollHeight)*0.9);
        if(Math.abs(value)>=maxScrollHeight&&mMaxScrollHeight!=0){
            value=(value<0)?-maxScrollHeight:maxScrollHeight;//设定最多下拉距离
        }
    ...
    public TextView[] getTitleViews() {
        return mHeaderLayout.getTitlesView();
    }

    public void setMaxScrollHeight(int maxHeight) {
        mMaxScrollHeight=maxHeight;
    }
    ...
    public static enum AnimationStyle {
        ...
        FLIP,
        /**
         * this is for user define styled Animations loading layout
         */
        STYLE,
        /**
         * 自定义加载动画
