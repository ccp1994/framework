package com.tfxk.framework.abs.swip;
...
import com.tfxk.framework.abs.swip.app.SwipeBackActivity;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    private boolean layoutUseScreenHeight;
    private SwipeBackActivity.OnActivityFinishedListener mActivityFinishListener;
    ...
    public void addFinishListener(SwipeBackActivity.OnActivityFinishedListener activityFinishListener) {
        this.mActivityFinishListener = activityFinishListener;
...
//    setMeasuredDimension(mScreenWidth,mScreenHeight*2);
    }

    public void setLayoutScreenHeight(boolean enable) {
        layoutUseScreenHeight = enable;
    }

    @Override
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        mInLayout = true;
        int layoutH = mContentView.getMeasuredHeight();
        int h = mContentView.getHeight();
        if (mContentView != null)
            if (layoutUseScreenHeight)
                layoutH = mScreenHeight;
